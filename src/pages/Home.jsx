        ...
        <div>
            ...
            <div className='relative mx-auto flex flex-col max-w-maxContent w-11/12 items-center
             text-white justify-between gap-8'>
                ...
                <div className='text-center text-4xl font-semibold'>
                    ...
                    <HighlightText text={"CodingSkills"} />
                </div>
            ...
            <div className='bg-pure-greys-5 text-richblack-700'>
                ...
                <div className='mx-auto w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-8'>
                    <div className='flex flex-col gap-7 justify-between lg:mt-20 lg:gap-0 lg:flex-row mb-10 mt-[-100px]'>
            ...
            {/* Section 3 */}
            <div className='relative w-11/12 mx-auto max-w-maxContent flex flex-col items-center justify-between gap-8 bg-richblack-900 my-20 text-white'>
                <InstructorSection />
